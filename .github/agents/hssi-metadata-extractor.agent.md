...
- links that **belong to another field** — an instrument *file format* → Input/Output File Formats, a data *source/archive* → Data Sources, a *phenomenon* → Related Phenomena (don't also list under 31/32 unless the software is genuinely designed to support the instrument itself);
